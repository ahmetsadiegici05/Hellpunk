...
public class MemoryPuzzleUI : MonoBehaviour
{
    ...
    private string[] cardSymbols = { "A", "B", "C", "D", "E", "F", "G", "H" };
    private Color cardBackColor = new Color(0.3f, 0.3f, 0.4f);
    private Color cardFrontColor = new Color(0.4f, 0.5f, 0.7f);
    private Color cardMatchedColor = new Color(0.3f, 0.7f, 0.4f);
    private Color cardHoverColor = new Color(0.5f, 0.6f, 0.8f);
